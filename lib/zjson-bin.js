...
(
  function() {
    ...
    function factory(_, msgpack, logger) {
      ...
      function differenceBetween(jsonObj1, jsonObj2) {
        ...
        _.forEach(_.keys(jsonObj1), (property) => {
          ...
          if (_.isArray(jsonObj1[property])) {
            return setDifferenceBetweenArrays(objDifferences, property, jsonObj1[property], jsonObj2[property]);
          }
          if (_.isObject(jsonObj1[property])) {
            return setDifferenceBetweenObjects(objDifferences, property, jsonObj1[property], jsonObj2[property]);
          }
          return setDifferenceBetweenPrimitives(objDifferences, property, jsonObj1[property], jsonObj2[property]);
        });
      ...
      function setDifferenceBetweenPrimitives(objDifferences, property, v1, v2) {
        if (!_.isEqual(v1, v2)) {
      ...
      function setDifferenceBetweenObjects(objDifferences, property, obj1, obj2) {
          // what fields of the object have changed?
        if (obj2) {
          const r = differenceBetween(obj1, obj2);
          if (!_.isEmpty(r)) {
            objDifferences[property] = r;
          }
        } else {
          // field does not exist in obj2
          const result = removeNil(obj1);
          if (!_.isNil(result)) {
            objDifferences[property] = result;
          }
        }
      ...
      function setDifferenceBetweenArrays(objDifferences, property, obj1Array, obj2Array) {
        ...
        for (let obj1Row of obj1Array) {
          ...
          if (obj2Row) {
            ...
            // const obj1RowId = obj1Array.indexOf(obj1Row);
            // const obj2RowId = obj2Array.indexOf(obj2Row);
            ...
            //  else if (obj1RowId !== obj2RowId) {
            //   rowDifferences.push({ id, $newPos: true });
            // }
          } else {
      ...
      function mergeChanges(jsonObj, changes) {
        _.forEach(changes, (newValue, property) => {
          ...
          if (_.isObject(newValue)) {
            ...
            } else if (_.isNil(jsonObj[property])) {
